...
class yangdar1en_ContigFilterDemo:
    '''
    Module Name:
...
This sample module contains one small method that filters contigs.
    ...
    ######################################### noqa
    VERSION = "0.0.1"
    GIT_URL = "git@github.com:dar1enyang/ContigDemo.git"
    GIT_COMMIT_HASH = "8a11f7d40b3bfc0faec2c2ff2cff86961ab95fdc"
    ...
    def run_yangdar1en_ContigFilterDemo(self, ctx, params):
        ...
        #BEGIN run_yangdar1en_ContigFilterDemo

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_yangdar1en_ContigFilterDemo function. Params=' + pformat(params))
        ...
        try:
            ...
            raise ValueError(
                'Cannot parse integer from min_length parameter (' + str(min_length_orig) + ')')
        if min_length < 0:
        ...
        report_info = report.create(
            {'report': reportObj, 'workspace_name': params['workspace_name']})
        ...
        #END run_yangdar1en_ContigFilterDemo

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_yangdar1en_ContigFilterDemo return value ' +
